...
@XmlRootElement(name = "ValidarVigToken")
public class ValidarVigToken {

    @XmlElementRef(name = "glsToken", namespace = "http://www.interseguro.com.pe/TokenServices/", type = JAXBElement.class, required = false)
